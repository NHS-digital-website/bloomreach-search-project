...
@HippoEssentialsGenerated(internalName = "bloomreachsearchproject:eventsdocument")
@Node(jcrType="bloomreachsearchproject:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public static final String DOCUMENT_TYPE = "bloomreachsearchproject:eventsdocument";
    ...
    private static final String END_DATE = "bloomreachsearchproject:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "bloomreachsearchproject:enddate")
